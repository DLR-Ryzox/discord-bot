...
module.exports = {
    run: async (message, args, client) => {
        ...
        channel.send(new Discord.MessageEmbed()
            .setDescription(`Bonjour ${message.member}, bienvenue dans votre ticket. Le Staff va s\'occuper de vous.`))
        message.channel.send(`Voici votre ticket ${channel} a été créé ${message.member} !`)
    },
    name: 'ticket',
    guildOnly: true
}